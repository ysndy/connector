...
public class Follow_List_Res_Request extends StringRequest {

    final static private String URL = "http://ysndy123.cafe24.com/Follow_List_Res.php"; // 서버 URL
    private Map<String, String> parameters;

    public Follow_List_Res_Request(String id, Response.Listener<String> listener) { //Constructor에서 두 번째 것 자동완성
