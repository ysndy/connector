...
public class CalendarRequest extends StringRequest {
    ...
    final static private String URL = "http://ysndy123.cafe24.com/TransactionCalendar.php"; // 서버 URL
    private Map<String, String> parameters;

    public CalendarRequest(String rstID, Response.Listener<String> listener) { //Constructor에서 두 번째 것 자동완성
        super(Method.POST, URL, listener, null);
        parameters = new HashMap<>();
        parameters.put("rstID", rstID);
